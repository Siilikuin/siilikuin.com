  ...
  return (
    <div className="min-h-screen bg-bg-base relative">
      ...
      <main className="px-8 md:px-12 py-16 max-w-7xl mx-auto relative z-10 mt-20">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-fg-violet mb-8">Documentation</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-bg-white p-6 rounded-xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-fg-violet mb-2">Getting Started Guide</h3>
            ...
            <div className="bg-bg-white p-6 rounded-xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-fg-violet mb-2">API Reference</h3>
              <p className="text-fg-gray mb-4">
            ...
            <div className="bg-bg-white p-6 rounded-xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-fg-violet mb-2">Architecture Patterns</h3>
              <p className="text-fg-gray mb-4">
        ...
        {/* Whitepapers Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-fg-violet mb-8">Whitepapers</h2>
          <div className="space-y-4">
            <div className="bg-bg-white p-6 rounded-xl flex justify-between items-center">
              <div>
                <h3 className="text-xl font-bold text-fg-violet mb-2">
                  Cloud Migration Strategies for Enterprise
                </h3>
                <p className="text-fg-gray mb-2">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-fg-violet mb-8">Tools & Downloads</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-bg-violet p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-fg-violet mb-4">Cloud Cost Calculator</h3>
            ...
            <div className="bg-bg-seafoam p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-fg-violet mb-4">Migration Assessment Tool</h3>
              <p className="text-fg-gray mb-6">
            ...
            <div className="bg-bg-gray p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-fg-violet mb-4">DevOps Starter Kit</h3>
              <p className="text-fg-gray mb-6">
            ...
            <div className="bg-bg-white border-2 border-fg-violet/20 p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-fg-violet mb-4">Code Templates</h3>
              <p className="text-fg-gray mb-6">
