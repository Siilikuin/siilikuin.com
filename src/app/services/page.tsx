      ...
      <main className="px-8 md:px-12 py-16 max-w-7xl mx-auto relative z-10 mt-20">
        ...
        <section className="grid md:grid-cols-2 gap-12 mb-20">
          <div className="bg-bg-white p-10 rounded-xl">
            <h2 className="text-3xl font-bold text-fg-violet mb-4">Cloud Migration</h2>
          ...
          <div className="bg-bg-white p-10 rounded-xl">
            <h2 className="text-3xl font-bold text-fg-violet mb-4">Custom Development</h2>
            <p className="text-fg-gray mb-6">
          ...
          <div className="bg-bg-white p-10 rounded-xl">
            <h2 className="text-3xl font-bold text-fg-violet mb-4">DevOps & CI/CD</h2>
            <p className="text-fg-gray mb-6">
          ...
          <div className="bg-bg-white p-10 rounded-xl">
            <h2 className="text-3xl font-bold text-fg-violet mb-4">Architecture Consulting</h2>
            <p className="text-fg-gray mb-6">
