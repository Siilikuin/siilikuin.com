      ...
      <main className="px-8 md:px-12 py-16 max-w-7xl mx-auto relative z-10 mt-20">
        <section className="mb-16">
          ...
          <p className="text-xl text-fg-gray max-w-3xl">
            Commercial products built and maintained by Siilikuin. These are tools I use myself and thought others might find useful too.
          </p>
        </section>
            ...
            <div className="p-10">
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-fg-seafoam font-medium">Finnish-English Dictionary</p>
                </div>
                <Link 
              ...
              <p className="text-fg-gray mb-6">
                A modern, fast Finnish-English dictionary that actually works. Built because existing options were either slow, 
                cluttered with ads, or required constant internet connection. Taskusanakirja works offline, loads instantly, 
                and focuses on one thing: helping you find the right word quickly.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-fg-gray mt-2 text-sm">
                    Regular updates with new words and features
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-bg-violet p-8 rounded-xl text-center">
          ...
          <p className="text-fg-white mb-6">
            I occasionally build tools that solve specific problems. If you have an idea that could help many people, let&apos;s talk.
          </p>
          <Link 
            href="/process"
