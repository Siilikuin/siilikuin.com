      ...
      <main className="px-8 md:px-12 max-w-4xl mx-auto py-20 relative z-10">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-bg-white p-8 rounded-xl shadow-sm">
            ...
            <p className="text-fg-gray mb-6">
              If we decide to work together, I&apos;ll spend two weeks writing up exactly what I understand needs to be built, how I&apos;d build it, and what it&apos;ll cost. This is about a day&apos;s worth of focused work, mostly evenings and weekends - I find I do my best thinking outside the 9-to-5 chaos.
            </p>
            <p className="text-fg-gray mb-6">
